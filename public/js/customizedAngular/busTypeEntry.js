angular.module('BusTypeApp', ['angularUtils.directives.dirPagination','customServiceModule'])
    .controller('BusTypeCtrl', function($scope, $http){
        ...
        $scope.Save = function() {
            ...
            $http.post("/export/bus/api/save-bus-type-data",data)
        ...
        $scope.update = function () {
            ...
            $http.post("/export/bus/api/update-bus-type-data",data)
                .then(function(response) {
        ...
        $scope.ExitTruck = function () {
            ...
            $http.post("/export/bus/api/update-bus-entry-data", data)
                .then(function (data) {
        ...
        $http.get("/export/bus/api/entrance-fee-data")
            .then(function(data){
        ...
        $http.get("/export/bus/api/bus-module-truck-type-data")
            .then(function(data){
        ...
        $scope.deleteTruck = function () {
            ...
            $http.get("/export/bus/api/delete-bus-type-data/" + $scope.de_id)
                .then(function (data) {
        ...
        $scope.GetAllExportTruck = function() {
            $http.get('/export/bus/api/get-bus-all-data-details/')
                .then(function(data) {
