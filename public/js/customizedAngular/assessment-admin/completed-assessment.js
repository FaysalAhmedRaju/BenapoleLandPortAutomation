angular.module('CompletedAssessmentApp', ['angularUtils.directives.dirPagination'])
	.controller('CompletedAssessmentCtrl', function($scope, $http,$filter){
		...
		$scope.totalAssessmentValueVat=0;
		...
		$scope.getCompletedAssessment = function(date,a) {
			...
			$http.get("/assessment-admin/api/get-completed-assessment/"+date+"/"+a)
				.then(function(data){
                    ...
                    //    console.log(data.data);
                        ...
                        //     $scope.totalAssessmentValueVat= $scope.totalAssessmentValue + $scope.totalAssessmentVat;
                        // })
                        // console.log($scope.totalAssessmentValue);
                        // console.log($scope.totalAssessmentVat);
                        // console.log($scope.totalAssessmentValueVat);
        ...
        $scope.$watch(function () {
            $scope.allTodaysCompletedAssessment = $scope.$eval("allData | filter: searchTextCompletedAssessment");
			//console.log($scope.allTodaysCompletedAssessment);
			$scope.dataDetailsShow($scope.allTodaysCompletedAssessment);

        });

        $scope.dataDetailsShow = function(data) {
        	console.log(data);
