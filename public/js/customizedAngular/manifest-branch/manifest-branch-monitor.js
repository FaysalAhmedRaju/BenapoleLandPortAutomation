angular.module('ManifestBranchApp', ['angularUtils.directives.dirPagination'])
    .controller('ManifestBranchCtrl', function($scope, $http,$filter){
        $scope.dataDiv = false;
       ...
       $scope.date = Y+"-"+M+"-"+D;
        ...
        $scope.shedYardName = function () {
            var data = {
                shed_yard: $scope.shed_yard
            }
            console.log(data)
            $http.post("/manifest-branch/api/shed-yard-type", data)
                .then(function (data) {
                    console.log(data.data);
                    console.log(data);
                    $scope.shed_yard_type_data = data.data;
        ...
        $scope.getCompletedAssessment = function(date,shed_yard,shed_yard_type) {
        	console.log(date, shed_yard, shed_yard_type);
            ...
            $http.get("/manifest-branch/api/get-date-shed-yard-wise-manifest-truck-data/"+date+"/"+shed_yard+"/"+shed_yard_type)
                .then(function(data){
                    console.log(data);
