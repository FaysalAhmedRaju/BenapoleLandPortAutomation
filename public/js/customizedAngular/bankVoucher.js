angular.module('bankVoucherApp', ['angularUtils.directives.dirPagination', 'customServiceModule'])
    .controller('bankVoucherCtrl', function ($scope, $http, enterKeyService,manifestService,$filter) {
        var today = new Date();
        ...
        $scope.getVoucherDetails = function (voucher) {
            ...
            $http.get("/super-admin/bank-voucher/api/get-details-data/" + voucher)
                .then(function (r) {
                     console.log(r);
                    ...
                    if (r.status == 204)//no voucher found
                    {
                        ...
                        if (r.data[0].v_id != null)//voucher found and  expenditure  found
                        {
                            ...
                            $scope.vouchar_no = r.data[0].bank_vouchar_no;
                            $scope.vouchar_date = r.data[0].bank_vouchar_date;
                            $scope.vouchar_no = r.data[0].bank_vouchar_no;
                            $scope.comment = r.data[0].comment;
                            $scope.cheque_no = r.data[0].cheque_no;
                            $scope.organization_name = r.data[0].organization_name;
        ...
        $scope.saveExpenditure = function (form) {
            ...
            if (form.$valid) {
                ...
                /*console.log(data);
                 ...
                 return*/
                $http.post("/super-admin/bank-voucher/api/save-bank-voucher-data", data)
                    .then(function (data) {
                        console.log(data);
                        if (data.status == 201) {
        ...
        $scope.getAllExpenditures = function (voucher_no) {
            ...
            $http.get("/super-admin/bank-voucher/api/get-all-bank-vouchers-data/" + voucher_no)
                .then(function (r) {
                       console.log(r.data[0])
                    if (r.data.length <= 0) {
                        ...
                        console.log( $scope.allExpendituresData );
                    }
        ...
        $scope.editExpense = function (i) {
            ...
            $scope.vouchar_no = i.bank_vouchar_no;
            ...
            $scope.vouchar_date = i.in_ex_date;
          //  console.log( $scope.vouchar_date);

            $scope.idSelectedRow = i.ex_id;
            $scope.ex_id_edit = i.ex_id;

            $scope.voucher_id = i.voucher_id;
            $scope.organization_name = i.organization_name;
            $scope.in_ex_date = i.in_ex_date;
            $scope.comment = i.comment;
            $scope.cheque_no = i.cheque_no;
        ...
        $scope.updateExpense = function (form) {
            ...
            if (form.$valid) {
                ...
                $http.put("/super-admin/bank-voucher/api/update-bank-voucher-data/" + $scope.ex_id_edit, data)
                    .then(function (r) {
                        console.log(r);
        ...
        $scope.deleteExpenditure = function () {
            ...
            $http.get("bank-voucher/api/delete-bank-vouchers-data/" + $scope.ex_id_delete)
                .then(function (r) {
                    console.log(r);
