angular.module('cnfApp', [])

    .controller('transPanelController', function($scope,$http) {
// console.log("ok")
        $scope.search = function(id) {
            ...
            $http.post("/api/searchManifestJsonTrans",data)
                .then(function (data) {
        ...
        $http.get("/api/GoodsJsonTrans")
            .then(function (data) {
                console.log(data)

                $scope.allGoodsDatatrans=data.data;

                console.log( $scope.allGoodsDatatrans);
            }).catch(function (r) {
        ...
        $scope.save=function () {
            ...
            $http.post("/api/TransPostingJson",data)

                .then(function (data) {

                    $scope.savingSuccess = 'Saved Successfully!';
                    $scope.savingErro=false;
        ...
        $scope.getVatsData=function () {
            ...
            $http.post("/api/TransGetVatDetails",data)
                .then(function (data) {
        ...
        $scope.update = function (form)
        {
            ...
            console.log(data);
            $http.put("/api/TransManifestTruckEntryJson", data)
                .then(function (data) {
        ...
        $scope.deleteTruck = function () {
            ...
            $http.delete("/api/TransTruckEntryDeleteJson/"+$scope.t)
