angular.module('manifestApp', ['ngTagsInput', 'ngTagsInput', 'customServiceModule'])
    .controller('manifestPostingController', function ($scope, $http, $filter, manifestService, enterKeyService) {
        ...
        $('#m_vat_id').autocomplete({
            source: "/transshipment/api/posting/get-vat-details",
            minLength: 5,
            highlightItem: true,
            // autoFocus:true,
        ...
        //package type start
        var packages=[];
        $http.get("/transshipment/api/posting/get-package-type")
            .then(function (data) {
                console.log(data);
       ...
       /* var packages1=[
        ...
        $scope.getItem = function (i) {
            $http.get('/transshipment/api/posting/get-goods-name/' + i)
                .then(function (response) {
                    // $scope.goodsName=
                }).catch(function (r) {
...
//---------------------------------------------------------Start search Function----------------------------------------
        $scope.search = function (id) {
            ...
            $http.post("/transshipment/api/posting/get-manifest-details", data)
                ...
                .then(function (data) {
                    ...
                    if (data.data.length == 0) {
                        ...
                        if (role_id == 12) {//for transshiment
                            console.log('oo')
                            //$scope.t_posted_yard_shed = 55;
                            //$scope.YardNOForLevelNO();
                            // $('.selectpicker').val([]);
                            // $('.selectpicker').trigger('change.abs.preserveSelected');
                            // $('.selectpicker').selectpicker('refresh');
                            // $('select[name=t_posted_yard_shed]').val(55);
        ...
        $http.get("/transshipment/api/posting/get-vat-data")
            .then(function (data) {
                // console.log(data.data)
        ...
        /* $scope.getVatsData=function () {
         ...
         $http.post("/api/getVatDetails",data)
         .then(function (data) {
        ...
        //     }
        //     console.log($scope.t_posted_yard_shed);
        //     $http.post("/api/countCurrentDateYardNo", data)
        //         .then(function (data) {
        //             console.log(data.data);
        ...
        //     };
        //     $http.post("/api/getVatName", data)       //function 4
        //         .then(function (data) {
        //             console.log(data.data);
        //             console.log(data.data[0].NAME);
        ...
        // $http.get("/api/YardDetailsJson")                   //function 5
        //     .then(function (data) {
        //             console.log(data.data);
...
//-------------------------------- Saveing Function is started From Here -----------------------------------------------
        $scope.save = function (postingform) {
            ...
            //return;
            console.log($scope.postingform.$invalid);
            console.log($scope.m_package_type);

            if ($scope.postingform.$invalid || !$scope.vatreg_id) {
            ...
            console.log(data);
            $http.post("/transshipment/api/posting/save-manifest-posting", data)
                .then(function (data) {
                    console.log(data)
                    //return;
                    ...
                    if (data.status == 209) {
                        ...
                        $("#error").show().fadeTo(2500, 500).slideUp(500, function () {
                            $("#error").slideUp(1000);
                        });
                        return;
                    }
                    ...
                    $http.post("/transshipment/api/posting/get-manifest-details", data)
                        .then(function (data) {
                            ...
                            console.log(data.data[0].yard_shed_name);
                            // $scope.m_nweight=data.data[0].m_nweight;
                            // $scope.m_marks_no=data.data[0].m_marks_no;
                            // $scope.driver_card=data.data[0].driver_card;
                            // $scope.driver_name=data.data[0].driver_name;
        ...
        $scope.SaveBin = function () {
            ...
            $http.post("/transshipment/api/posting/save-importer-data", data)
                .then(function (data) {
                    console.log(data);
