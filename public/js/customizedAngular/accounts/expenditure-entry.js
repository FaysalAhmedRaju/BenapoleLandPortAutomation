angular.module('expenditureApp', ['angularUtils.directives.dirPagination', 'customServiceModule'])
    .controller('expenditureCtrl', function ($scope, $http, enterKeyService,manifestService,$filter) {
      ...
      $scope.getVoucherDetails = function (voucher) {
        ...
        $scope.editExpense = function (i) {
            ...
            $scope.amount = parseFloat(i.debit);
