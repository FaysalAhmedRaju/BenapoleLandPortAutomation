...
@section('script')
	...
	{!!Html :: script('js/customizedAngular/AssessmentVerificationDetails.js')!!}
...
@endsection
@section('content')
	<div class="col-md-12 ng-cloak text-center" ng-app="AssessmentVerificationApp" ng-controller="AssessmentVerificationCtrl">
		...
		<div class="col-md-5 col-md-offset-3" style="background-color: #dbd3ff; border-radius: 20px;">
