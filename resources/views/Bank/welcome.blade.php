...
<section class="content-header">
    ...
    <h1>
        Dashboard
        <small><b><i>Bank</i></b> Control panel</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                <div class="inner">
                    <h3>{{$Trucks_of_manifest[0]->total_amount_bank}}
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                <div class="inner">
                    <h3>{{$todaysManifestByUser[0]->total_user}}<sup style="font-size: 20px"> Manifest</sup></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                <div class="inner">
                    <h3>{{$todaysTruckByUser[0]->total_amount_bank}}<sup style="font-size: 20px"> Truck</sup></h3>
