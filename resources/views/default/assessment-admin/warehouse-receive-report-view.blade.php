...
@section('content')
    <div class="col-md-12 text-center">
        <h3 class="ok" style="font-weight: bold;">WareHouse(Receive) Reports</h3>
        <hr>


        <div class="col-md-3 reportFormStyle">
            <h4 class="ok headingTxt">Receive:</h4>

            <form action="{{route('assessment-admin-warehouse-receive-date-wise-report')}}" target="_blank" method="POST"
                  class="form-inline">
                {{ csrf_field() }}
