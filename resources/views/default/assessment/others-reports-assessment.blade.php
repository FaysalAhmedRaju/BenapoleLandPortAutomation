    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3 reportFormStyle">
                ...
                <form action="{{ route('assessment-user-and-date-wise-report') }}" target="_blank" method="POST">
                    {{ csrf_field() }}
            ...
            <div class="col-md-3 reportFormStyle">
                ...
                <form action="{{ route('assessment-monthly-entry-report') }}" target="_blank" method="POST">
                    {{ csrf_field() }}
                    <table>
                        <tr>
                            <td>
