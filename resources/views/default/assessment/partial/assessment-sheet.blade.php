...
@section('script')
    ...
    {{--  <link rel="stylesheet" href="https://kendo.cdn.telerik.com/2017.3.913/styles/kendo.common.min.css"/>
      ...
      <script src="https://kendo.cdn.telerik.com/2017.3.913/js/kendo.all.min.js"></script>
   --}}
    {!!Html :: script('js/customizedAngular/assessment-partial-test.js')!!}
...
@section('content')
    <div class="col-md-12 text-center" ng-app="assessmentApp" ng-controller="assessmentCtrl" ng-cloak>
        ...
        <div class="col-md-4" style="">
            ...
            <a href="/assessment/partial-assessment-report/@{{ manifes_no }}/@{{ partial_status }}" ng-disabled="!manifes_no" target="_blank"
