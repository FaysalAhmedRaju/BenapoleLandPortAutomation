...
<body>
    ...
    @php
        ...
        $perishable = isset($perishable_flag) ? $perishable_flag : 0;
    @endphp
    <tbody>
        <tr>
            <td rowspan="17">
            ...
            <td rowspan="3">  {{-----------------GOODS NAME FROM Assesment saves--------------------}}
                {{ isset($good_description) ? $good_description : "" }}
            </td>
            <td rowspan="3">  {{----------------From Manifest--------------------}}
                {{ count($manifestReport) ? $manifestReport[0]->package_no : "" }}
            </td>
            <td rowspan="3">   {{--------------From Assessment Saves--------------}}
                {{ isset($weight) ? $weight : "" }}
            </td>
            {{-----------------PERIOD TO AMOUNT--------------------}}
            {{--FIRST SLAB--}}
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <table id="item-wise-carhge" border="0" width="100%" style="border: none">
                                            @php($danger=1)
                                            <tr>
                                                <td style=""><b>{{ $item->slab }}</b></td>
                                                <td style="text-align: right">
                                                    {{$item->item_quantity }} X {{ $item->slab_duration_day }} X {{ $item->charge }}
                                                    @if($item->dangerous=='1')
        ...
        <tr>
            ...
            @php
                if(count($totalWarehouseRent)) {
                    if($totalWarehouseRent[0]->tcharge != 0) {
                        $TotalSlabCharge = number_format($totalWarehouseRent[0]->tcharge, 2,'.','');
        ...
        <tr>
            ...
            <td>
                <b>Off Loading</b><br>
                {!! count($offLoadingLabour) && $perishable == 0 ? ($offLoadingLabour[0]->tcharge != 0 ? $tickMark : "") : "" !!}
                a) By Manual Labour<br>
                {!! count($offLoadingEquipment) && $perishable == 0 ? ($offLoadingEquipment[0]->tcharge != 0 ? $tickMark : "") : "" !!}
                b) By BLPA Equipment
            </td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td>
                {!! count($offLoadingLabour) && $perishable == 0 ? ($offLoadingLabour[0]->tcharge != 0 ? $offLoadingLabour[0]->unit." X ".$offLoadingLabour[0]->charge_per_unit.(count($offLoadingLabour) && count($offLoadingEquipment) && $perishable == 0 ? "<br>".(count($offLoadingEquipment)  && $perishable == 0 ? ($offLoadingEquipment[0]->tcharge != 0 ? $offLoadingEquipment[0]->unit." X ".$offLoadingEquipment[0]->charge_per_unit.(!is_null($offLoadingEquipment[0]->other_unit) && $offLoadingEquipment[0]->other_unit != 0 ? " X 2" : "") : "") : "") : "") : "".(count($offLoadingEquipment)  && $perishable == 0 ? ($offLoadingEquipment[0]->tcharge != 0 ? $offLoadingEquipment[0]->unit." X ".$offLoadingEquipment[0]->charge_per_unit.(!is_null($offLoadingEquipment[0]->other_unit) && $offLoadingEquipment[0]->other_unit != 0 ? " X 2" : "") : "") : "")) : "".(count($offLoadingEquipment)  && $perishable == 0 ? ($offLoadingEquipment[0]->tcharge != 0 ? $offLoadingEquipment[0]->unit." X ".$offLoadingEquipment[0]->charge_per_unit.(!is_null($offLoadingEquipment[0]->other_unit) && $offLoadingEquipment[0]->other_unit != 0 ? " X 2" : ""): "") : "") !!}
            </td>
            <td></td>
            <td></td>
            @php
                if(count($offLoadingLabour) && $perishable == 0) {
                ...
                if(count($offLoadingEquipment) && $perishable == 0) {
        ...
        <tr>
            ...
            <td>
                <b>Loading</b><br>
                {!! count($loadingLabour) && $perishable == 0 ? ($loadingLabour[0]->tcharge != 0 ? $tickMark : "") : "" !!}
                a) By Manual Labour<br>
                {!! count($loadingEquip) && $perishable == 0 ? ($loadingEquip[0]->tcharge != 0 ? $tickMark : "") : "" !!}
                b) By BLPA Equipment
            </td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td>
                {!! count($loadingLabour) && $perishable == 0 ? ($loadingLabour[0]->tcharge != 0 ? $loadingLabour[0]->unit." X ".$loadingLabour[0]->charge_per_unit.(count($loadingLabour) && count($loadingEquip) && $perishable == 0 ? "<br>".(count($loadingEquip) ? ($loadingEquip[0]->tcharge != 0 ?$loadingEquip[0]->unit." X ".$loadingEquip[0]->charge_per_unit.(!is_null($loadingEquip[0]->other_unit) && $loadingEquip[0]->other_unit != 0 ? " X 2" : "") : "") : "") : "") : "".(count($loadingEquip) && $perishable == 0 ? ($loadingEquip[0]->tcharge != 0 ?$loadingEquip[0]->unit." X ".$loadingEquip[0]->charge_per_unit.(!is_null($loadingEquip[0]->other_unit) && $loadingEquip[0]->other_unit != 0 ? " X 2" : "") : "") : "")) : "".(count($loadingEquip) && $perishable == 0 ? ($loadingEquip[0]->tcharge != 0 ?$loadingEquip[0]->unit." X ".$loadingEquip[0]->charge_per_unit.(!is_null($loadingEquip[0]->other_unit) && $loadingEquip[0]->other_unit != 0 ? " X 2" : "") : "") : "") !!}
            </td>
            <td></td>
            <td></td>
            @php
                if(count($loadingLabour) && $perishable == 0) {
                    if($loadingLabour[0]->tcharge != 0) {
                        list($loLataka, $loLaps) = explode(".", $loadingLabour[0]->tcharge);
                        $totalAmount += $loadingLabour[0]->tcharge;
                    }
                }
                if(count($loadingEquip) && $perishable == 0) {
            ...
            @endphp
            <td class="amount-right">
                {!! isset($loLataka) && $perishable == 0 ? $loLataka.(isset($loLataka) && isset($loEqtaka) && $perishable == 0 ? "<br>".(isset($loEqtaka) && $perishable == 0 ? $loEqtaka : "") : "") : "".(isset($loEqtaka) && $perishable == 0 ? $loEqtaka : "") !!}
            </td>
            <td class="amount-right">
                {!! isset($loLaps) && $perishable == 0 ? $loLaps.(isset($loLaps) && isset($loEqFTps) && $perishable == 0 ? "<br>".(isset($loEqFTps) && $perishable == 0 ? $loEqFTps : "") : "") : "".(isset($loEqFTps) && $perishable == 0 ? $loEqFTps : "") !!}
            </td>
        </tr>
        {{-----------------Loading--------------------}}
        {{-- Transshipment [When Perishable Flag is 1 loading details showns] --}}
        <tr>
            <td>
                <b>4.</b>
            </td>
            <td>
                ...
                Transhipment</b><br>
                {!! count($loadingLabour) && $perishable == 1 ? ($loadingLabour[0]->tcharge != 0 ? $tickMark : "") : "" !!}
                a) By Manual Labour<br>
                {!! count($loadingEquip) && $perishable == 1 ? ($loadingEquip[0]->tcharge != 0 ? $tickMark : "") : "" !!}
                b) By BLPA Equipment
            </td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td>
                {!! count($loadingLabour) && $perishable == 1 ? ($loadingLabour[0]->tcharge != 0 ? $loadingLabour[0]->unit." X ".$loadingLabour[0]->charge_per_unit.(count($loadingLabour) && count($loadingEquip) && $perishable == 1 ? "<br>".(count($loadingEquip) ? ($loadingEquip[0]->tcharge != 0 ?$loadingEquip[0]->unit." X ".$loadingEquip[0]->charge_per_unit.(!is_null($loadingEquip[0]->other_unit) && $loadingEquip[0]->other_unit != 0 ? " X 2" : "") : "") : "") : "") : "".(count($loadingEquip) && $perishable == 1 ? ($loadingEquip[0]->tcharge != 0 ? $loadingEquip[0]->unit." X ".$loadingEquip[0]->charge_per_unit.(!is_null($loadingEquip[0]->other_unit) && $loadingEquip[0]->other_unit != 0 ? " X 2" : "") : "") : "")) : "".(count($loadingEquip) && $perishable == 1 ? ($loadingEquip[0]->tcharge != 0 ?$loadingEquip[0]->unit." X ".$loadingEquip[0]->charge_per_unit.(!is_null($loadingEquip[0]->other_unit) && $loadingEquip[0]->other_unit != 0 ? " X 2" : "") : "") : "") !!}
            </td>
            <td></td>
            <td></td>
            @php
                if(count($loadingLabour) && $perishable == 1) {
                    if($loadingLabour[0]->tcharge != 0) {
                        list($loLataka, $loLaps) = explode(".", $loadingLabour[0]->tcharge);
                        $totalAmount += $loadingLabour[0]->tcharge;
                    }
                }
                if(count($loadingEquip) && $perishable == 1) {
                    if($loadingEquip[0]->tcharge != 0) {
                        list($loEqtaka, $loEqFTps) = explode(".", $loadingEquip[0]->tcharge);
                        $totalAmount += $loadingEquip[0]->tcharge;
                    }
            ...
            @endphp
            <td class="amount-right">
                {!! isset($loLataka) && $perishable == 1 ? $loLataka.(isset($loLataka) && isset($loEqtaka) && $perishable == 1 ? "<br>".(isset($loEqtaka) && $perishable == 1 ? $loEqtaka : "") : "") : "".(isset($loEqtaka) && $perishable == 1 ? $loEqtaka : "") !!}
            </td>
            <td class="amount-right">
                {!! isset($loLaps) && $perishable == 1 ? $loLaps.(isset($loLaps) && isset($loEqFTps) && $perishable == 1 ? "<br>".(isset($loEqFTps) && $perishable == 1 ? $loEqFTps : "") : "") : "".(isset($loEqFTps) && $perishable == 1 ? $loEqFTps : "") !!}
            </td>
        </tr>
        {{-- Transshipment End [When Perishable Flag is 1 loading details showns] --}}
        ...
        <tr>
            ...
            <td></td>
            <td>
            	{{ count($localTruck) ? ($localTruck[0]->tcharge != 0 ? "T-> ".$localTruck[0]->unit." X ".$localTruck[0]->charge_per_unit : "") : "" }}
                {!! count($localTruck) && count($localVan) ? "<br>" : "" !!}
                {{ count($localVan) ? ($localVan[0]->tcharge != 0 ? "V-> ".$localVan[0]->unit." X ".$localVan[0]->charge_per_unit : "") : "" }}
            </td>
            <td></td>
            <td></td>
            @php
                ...
                if(count($localVan)) {
                    if($localVan[0]->tcharge != 0) {
                        list($LVtaka, $LVps) = explode(".", $localVan[0]->tcharge);
                        $totalAmount += $localVan[0]->tcharge; 
                    }
                }
			@endphp
            <td class="amount-right">
                {{ isset($LTtaka) ? $LTtaka : "" }}
                {!! isset($LTtaka) && isset($LVtaka) ? "<br>" : "" !!}
                {{ isset($LVtaka) ? $LVtaka : "" }}
            </td>

            <td class="amount-right">
                {{ isset($LTps) ? $LTps : "" }}
                {!! isset($LTps) && isset($LVps) ? "<br>" : "" !!}
                {{ isset($LVps) ? $LVps : "" }}
            </td>
        </tr>
        {{----------------LOCAL TRUCK CHARGES------------------}}
        ...
        <tr>
            ...
            <td></td>
            <td>
            	{!! count($weighmentChargesFT) ? ($weighmentChargesFT[0]->tcharge != 0 ? $weighmentChargesFT[0]->unit." X ".floatval($weighmentChargesFT[0]->other_unit)." X ".$weighmentChargesFT[0]->charge_per_unit.(count($weighmentChargesFT) && count($weighmentChargesLT) ? "<br>".(count($weighmentChargesLT) ? ($weighmentChargesLT[0]->tcharge != 0 ? $weighmentChargesLT[0]->unit." X ".floatval($weighmentChargesLT[0]->other_unit)." X ".$weighmentChargesLT[0]->charge_per_unit : "") : "") : "") : "".(count($weighmentChargesLT) ? ($weighmentChargesLT[0]->tcharge != 0 ? $weighmentChargesLT[0]->unit." X ".floatval($weighmentChargesLT[0]->other_unit)." X ".$weighmentChargesLT[0]->charge_per_unit : "") : "")) : "".(count($weighmentChargesLT) ? ($weighmentChargesLT[0]->tcharge != 0 ? $weighmentChargesLT[0]->unit." X ".floatval($weighmentChargesLT[0]->other_unit)." X ".$weighmentChargesLT[0]->charge_per_unit : "") : "") !!}
            </td>
            <td></td>
            <td></td>
            @php
        ...
        <tr>
            ...
            @php
                if($vat_flag == 1 || is_null($vat_flag)) {
                   ...
                   $totalAmountWithVat = number_format($totalAmount_ceil,2,'.',''); 
                }
