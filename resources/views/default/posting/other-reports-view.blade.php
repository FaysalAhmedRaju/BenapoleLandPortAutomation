...
@section('title', 'Posting Others Report')
@section('script')
@endsection
@section('style')
    <style type="text/css">
            ...
            <div class="col-md-12">
                <div class="col-md-5">
                   <div class="list-group text-center">
                        <a class="list-group-item" href="{{route('posting-truck-entry-done-but-posting-branch-entry-not-done-report')}}" target="_blank">Truck Entry Done, But Posting Branch Entry Not Done Report</a>
                    </div> 
                </div>
                <div class="col-md-3 reportFormStyle">
                    <h6 class="ok headingTxt"><b>Monthly Posting Entry:</b></h6>
                    <form action="{{ route('posting-get-monthly-entry-report') }}" target="_blank" method="POST">
                        {{ csrf_field() }}
                        <table>
                            <tr>
                                <td>
                ...
                <div class="col-md-3 reportFormStyle">
                    ...
                    <form action="{{ route('posting-get-yearly-entry-report') }}" target="_blank" method="POST">
                        {{ csrf_field() }}
                        <table>
                            <tr>
                                <td>
