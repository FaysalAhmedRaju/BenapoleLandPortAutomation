...
@section('script')
    {!!Html :: script('js/customizedAngular/posting/posting.js')!!}
...
@section('content')
    <div class="col-md-12"  style="padding: 0;" ng-cloak=""  ng-app="manifestApp" ng-controller="manifestPostingController" ng-cloak>
        ...
        <div class="col-md-11 col-md-offset-1" style="padding-bottom: 30px;">
            ...
            <div class="col-md-4">
                <a href="{{ route('posting-todays-manifest-report') }}" target="_blank">
                    <button type="button" class="btn btn-primary">
                        <span class="fa fa-search"></span>Today's Manifest
                    </button>
                </a>
                <a href="/posting/manifest-posting-details-report/@{{ ManifestNo }}" target="_blank">
       ...
       {{-- col-md-offset-1--}}
        <div class="col-md-12 table-responsive {{--col-md-offset-1--}}" style="background-color: #f8f9f9; /*border-radius: 10px; padding: 5px 5px 5px 5px;*/">
            <h4 class="text-center ok">Manifest Posting Form</h4>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <tags-input ng-model="goods_id"
                                    ...
                                    on-tag-removed="tagRemoved($tag)" onkeydown="EnterToTab(m_gweight)">
                ...
                <tr>
                    ...
                    <td>
                       {{-- <label class="radio-inline">
                        ...
                        <input style="width: 190px;" type="text" required  class="form-control"  ng-model="m_vat_id" name="m_vat_id" id="m_vat_id" {{--ng-blur="getVatsData()"--}}
                                placeholder="VAT No" onkeydown="EnterToTab(m_exporter_name_addr)">
              ...
              {{--  <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select title="" style="width: 190px;" class="selectpicker" name="t_posted_yard_shed"
                                ng-model="t_posted_yard_shed" required {{-- ng-options="yard.id as yard.yard_shed_name for yard in allYardData" --}}
                        ng-hide="hidemanifestWhenUpdatebtnClick" {{-- ng-change="YardNOForLevelNO()" --}} multiple>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width: 190px;"  ng-disabled="manif_posted_btn_disable" class="form-control"
                               ng-model="remark" name="remark" id="remark" ng-hide="hidemanifestWhenUpdatebtnClick"
                               placeholder="Remark" onkeydown="EnterToTab(saveBtn)">
