...
<html>
<head>
    <title>Truck Wise Export Report</title>
    <style>
        .center {
            position: absolute;
            text-align: center;
    ...
    <tr>
        ...
        <td style="  /*width: 75%;*/ ">
            <p style="text-align: center;   margin-bottom: 0; margin-top: 0;">
                ...
                <span style="font-size: 19px;">Traffic Division</span>

            </p>
            <p class="paraMessage" style="font-size: 12px; /*background-color: yellow;*/ ">Local Truck Entry at Int. Export Truck Terminal and Haltage Charge Sheet</p>


          {{--  <p class="testParagraph" style="font-size: 12px; background-color: greenyellow; ">Local Truck Entry at Int. Export Truck Terminal and Haltage Charge Sheet</p>--}}
        </td>

        <td style="/*background-color: #00e765; width:15%;*/">
            <p style="font-size: 15px">Driver Copy</p>
            <p style="font-size: 15px">SI.No: {{$truck_id}}</p>
        </td>
    </tr>
</table>
...
<div style="padding: 0">
    ...
    <table class="tablBackGroundImage" style="box-shadow: 0px 0px 1px 1px darkgrey; width: 100%; ">
        ...
        {{--<tr>--}}
            ...
            {{--</td>--}}
            {{--<td --}}{{--colspan="2"--}}{{-- style=" border-bottom: dotted 1px; ">--}}
