...
@section('script')
    ...
    {!! Html::script('js/customizedAngular/export/export-challan.js') !!}

@endsection
@section('content')
    <div class="col-md-12 ng-cloak" ng-app="ExportChallanApp" ng-controller="ExportChallanCtrl">


        {{--<div class="col-md-12 col-md-offset-9" style="">--}}
            {{--<a href="GetExportChallanPdfReport/@{{ searchChallanNO }}" target="_blank" class="btn btn-primary">Challan Report</a>&nbsp;--}}
            {{--<button type="button" class="btn btn-primary"  data-target="#addTruckFormModal" ng-click="createChallan(searchChallanNO)" data-toggle="modal">Add Truck</button>--}}
        {{--</div>--}}
        <div class="col-md-12 {{--col-md-offset-1--}}">
            <div class="col-md-4" style="/*background-color: red;*/ text-align: left; padding: 0px;">
                <form action="{{ route('export-truck-month-wise-truck-challan-report') }}" target="_blank" method="POST">
                    {{ csrf_field() }}
            ...
            <div class="col-md-2 {{--col-md-offset-1--}}" style="/*background-color: red;*/ text-align: right; padding: 0px;" >
                <a href="{{ route('export-truck-todays-truck-challan-report') }}" target="_blank">
            ...
            <div class="col-md-3 {{--col-md-offset-0--}}"   style="/*background-color: yellow;*/ text-align: right; padding: 0px;"  >
                ...
                <form action="{{ route('export-truck-date-wise-truck-challan-report') }}" target="_blank" method="POST" class="form-inline">
                    {{ csrf_field() }}
                    <div class="input-group">
            ...
            <div class="col-md-3 {{--col-md-offset-1--}}">
                ...
                <form action="{{ route('export-truck-yearly-truck-challan-report') }}" target="_blank" method="get">
                    <table>
                        <tr >
        ...
        {{--<div class="col-md-12">--}}
            ...
            {{--<form class="form-inline" name="callan_Form_Challan_no" id="callan_Form_Challan_no" novalidate >--}}
                {{--<table>--}}
                    {{--<tr>--}}
                        {{--<th>Challan NO:&nbsp;</th>--}}
                        {{--<td>--}}
                            {{--<input type="text" style="width: 190px;" class="form-control input-sm" ng-model="export_challan_no" name="export_challan_no"  id="export_challan_no" placeholder="Challan No" required>--}}
                            {{--<span class="error" ng-show="callan_Form_Challan_no.export_challan_no.$invalid && submitted">Challan No is required</span>--}}
                        {{--</td>--}}
                    {{--</tr>--}}
                {{--</table>--}}
            {{--</form>--}}
            ...
            {{--<form class="form-inline" name="callan_Form" id="callan_Form" novalidate >--}}
                {{--<table>--}}
                    {{--<tr>--}}
                        {{--<th>Challan NO:&nbsp;</th>--}}
                        {{--<td>--}}
                            {{--<input type="text" style="width: 190px;" class="form-control input-sm" ng-model="export_challan_no" name="export_challan_no"  id="export_challan_no" placeholder="Challan No" >--}}
                        {{--</td>--}}
                    {{--</tr>--}}
                {{--</table>--}}
            {{--</form>--}}
        ...
        <div class="col-md-9 col-md-offset-1" {{--style="/*background-color: #dbd3ff;*/ border-radius: 1px;"--}}>


            {{--<h4 class="text-center ok">Export Challan</h4>--}}
            {{--<br>--}}

            <div class="col-md-5  col-md-offset-4" >
                {{--<form class="form-inline" name="ExTruckEntryExitForm" id="ExTruckEntryExitForm" novalidate ng-submit="searchChallan(searchChallanNO)">--}}
                {{--<div class="form-group">--}}
                {{--<label for="searchText">Search:</label>&nbsp;--}}
                {{--<input type="text" ng-model="searchChallanNO" name="searchChallanNO" class="form-control input-sm" id="searchChallanNO" placeholder="Challan No" >--}}
                {{--</div>--}}
                {{--</form>--}}
                ...
                <div class="form-group" style="width: 200px">
                    <input type="text" class="form-control datePicker" name="from_date" id="from_date"
                           placeholder="Select Date For Challan" ng-model="from_date" ng-change="searchChallan(from_date)" >
                </div>
        ...
        <div class="col-md-12 table-responsive" >
            <table class="table table-bordered text-center"  ng-hide="Truck_List">
                ...
                <tbody>
                <tr dir-paginate="ChTruck in newTruckSearch | orderBy: 'ChTruck.id':true |    itemsPerPage:itemPerpage">
                    <td >
                    ...
                    {{--<td>@{{ ChTruck.truck_type | truckTypeFilter }}</td>--}}
                    {{--<td>@{{ ChTruck.driver_name }}</td>--}}
                    <td>@{{ ChTruck.entry_datetime }}</td>
                    <td>@{{ ChTruck.haltage_day }}</td>
                    <td>@{{ ChTruck.entrance_fee }}</td>
                    {{--<td>@{{ ChTruck.exit_datetime }}</td>--}}
                    {{--<td>--}}
            ...
            <table class="table table-bordered text-center" ng-hide="New_Added_Truck_List">
                <caption><h4 class="text-center ok">New Added Truck List</h4>{{--<label class="form-inline">Search:<input class="form-control" ng-model="searchText"></label>--}}</caption>
                <thead>
                <tr>
                    <th>S/L</th>
                    <th>Truck No</th>
        ...
        <div class="col-md-7 col-md-offset-2" style="background-color: #f8f9f9; /*border-radius: 10px; padding: 5px 5px 5px 5px;*/">
            <h4 class="text-center ok">Truck Challan Form</h4>
            <form class="form-inline" name="callan_Form" id="callan_Form" novalidate >
                <table>
                    <tr>
                        <th>Miscellaneous:&nbsp;</th>
        ...
        <div class="col-md-12 table-responsive" ng-hide="Created_challan_list_show">
            <table class="table table-bordered text-center">
                <caption><h4 class="text-center ok">Challan List</h4><label class="form-inline">Search : <input class="form-control" ng-model="searchTextList" placeholder="Search"></label></caption>
                <thead>
                <tr>
                    <th>S/L</th>
                    <th>Challan NO</th>
                ...
                <tbody>
                <tr dir-paginate="challan in allExChallanList | orderBy: 'challan.id':true | filter:searchTextList |  itemsPerPage:itemPerpage " pagination-id="branch">
                    <td>@{{ $index + serial }}</td>
                    <td>@{{ challan.export_challan_no }}</td>
                    <td>@{{ challan.create_datetime }}</td>
                    <td>
                        {{--<a  href="GetExportChallanPdfReport/@{{challan.export_challan_no}}/@{{challan.challan_date}}" class="btn btn-success" target="_blank">Challan Report</a>--}}
                        <a  href="/export/truck/challan-wise-export-truck-report/@{{challan.export_challan_no}}" class="btn btn-success" target="_blank">Challan Report</a>
                    </td>
                    <td>
                        <a class="btn btn-danger btn-md" ng-click="delete(challan)"
                           data-target="#deleteChallan" data-toggle="modal">Delete</a>
                    </td>
                </tr>
                </tbody>
                <tfoot>
        ...
        {{-- ------------------------Delete Model----------------------------}}
        <div class="modal fade" id="deleteChallan" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a href="" class="btn btn-primary center-block pull-right" ng-click="deleteFinalChallanFunc()">Yes</a>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">No</button>
                    </div>
                    <div class="modal-footer">
                        <span ng-show="deleteFailMsg">Something wrong!</span>
                        <div id="deleteSuccess" class="alert alert-success text-center" {{--class="alert alert-warning text-center"--}} ng-show="deleteSuccessMsg">
    ...
    <!-- addTruckFormModal Modal START=====================================================================================================     add Truck MODAL     ========== -->
                ...
                <div class="modal-content largeModal" id="">
                    ...
                    <div class="modal-body">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                    <tr dir-paginate="ChTruckList in challanIncomTruckList | orderBy: 'ChTruckList.id':true | filter:searchText| itemsPerPage:10 " pagination-id="cust">
                                        <td>
