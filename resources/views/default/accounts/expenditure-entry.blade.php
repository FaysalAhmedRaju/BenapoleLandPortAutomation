...
@section('content')
    ...
    <div class="col-md-12 text-center" ng-app="expenditureApp" ng-controller="expenditureCtrl">
        ...
        <div class="col-md-12" style="padding-bottom: 30px;">
            <div class="col-md-5">
                <form action="{{ route('accounts-expenditure-report-date-wise-voucher-report') }}" target="_blank" method="POST" class="form-inline">
                    {{ csrf_field() }}
            ...
            <div class="col-md-4">
                ...
                <a href="/accounts/expenditure/report/voucher-report/@{{ voucherNo }}" target="_blank">
                    <button ng-disabled="!voucherNo" type="button" class="btn btn-primary">
                        <span class="fa fa-calendar-o"></span> Voucher Report
                    </button>
                </a>

                <a href="/accounts/expenditure/report/todays-voucher-report" target="_blank">
        ...
        <div class="col-md-12" style=" border-radius: 5px; padding: 10px 0 5px 10px;">
            <div class="col-md-6">
                ...
                <form action="{{ route('accounts-expenditure-report-month-wise-voucher-report') }}" target="_blank" method="POST">
                    {{ csrf_field() }}
            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('accounts-expenditure-report-source-wise-voucher-report') }}" target="_blank" method="POST">
                    {{ csrf_field() }}
                    {{--   <div class="col-md-4">--}}
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <select style="width: 200px" class="form-control" name="voucher_report"
                                        ...
                                        ng-options="head.id as head.acc_head for head in allHeadData" {{--ng-change="getSubHead(head_id)"--}}>
        ...
        <div class="col-md-12"> {{--Expenditure entry and Data  Div--}}
                    ...
                    <table id="" style="width: 100%">
                        <tr>
                            <td class="text-center" colspan="6">
                                <h4 class="ok"> Expenditure Entry Form</h4>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>&nbsp;Expenditure<span class="mandatory">*</span>:</th>
                            <td>
