...
<p class="center">
    ...
    <span style="font-size: 19px;">Sub Head Wise Monthly Expenditure Voucher Report </span> <br>
    <span style="font-size: 19px;">Name:&nbsp; {{$acc_sub_head}}</span> <br>
    <span style="font-size: 19px;"> From Date: {{$from_date_sub}} to Date: {{$to_date_sub}}</span>
...
<table style="page-break-inside:avoid;">
    ...
    <tr>
        ...
        <th style="border: none !important; text-align: left"colspan="3">&nbsp;<span style="text-transform: capitalize">{{convert_number_to_words(ceil($amount) )." Taka only"}}</span><br></th>
    </tr>
    </tfoot>
</table>
