...
<p class="center">
    ...
    <span style="font-size: 19px;">Source Wise Income Voucher Report </span> <br>
    <span style="font-size: 19px;">Source Name: {{$source_name}}</span> <br>
...
<table style="page-break-inside:avoid;">
    ...
    @foreach($expenditure as $key => $ex)
        <tr>
            ...
            <td>{{ $ex->username}}</td>
            <td class="txt-right">{{ number_format($ex->credit , 2, '.', ',')}}</td>
        </tr>
    @endforeach
    </tbody>
    <tfoot>
    ...
    <tr>
        ...
        <th style="border: none !important; text-align: left"colspan="5">&nbsp;<span style="text-transform: capitalize">{{convert_number_to_words(ceil($amount) )." Taka only"}}</span><br></th>
    </tr>
    </tfoot>
</table>
