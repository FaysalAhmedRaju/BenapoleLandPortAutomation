...
@section('content')
    ...
    <section class="content-header">
        <p class="welcome-message text-center text-capitalize">You are Welcome, <b>{{Auth::user()->name}} ( <span
        ...
        <h1>
            Dashboard
            <small><b><i>Truck Entry</i></b> Control panel</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3>{{$todaysTotalChassisSelf[0]->totalChassisSelf}} <sup style="font-size: 20px"> Chassis</sup>
                        </h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{$todaysManifestTotal[0]->total_manifest}}
