...
@section('title', 'Truck To Truck Delivery Request')
...
@section('script')
    ...
    {!!Html :: script('js/customizedAngular/warehouse/truck-to-truck-delivery-request.js')!!}

@endsection

@section('content')
    <div ng-app="truckToTruckDeliveryRequestApp" ng-controller="truckToTruckDeliveryRequestCtrl" ng-cloak>
        ...
        <div class="col-md-10 col-md-offset-1 table-responsive" style="background-color: #e3e8e8; border-radius: 5px; padding: 5px 10px; text-align: center">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="text-center" colspan="6">
                            <h4 class="ok">Truck To Truck Delivery Request</h4>
                            <br>
                        </td>
                    </tr>
            ...
            <div id="manifestDetails" ng-hide="todaysEntryDiv">
                ...
                <table class="table table-bordered table-hover table-striped" id="manifestTbl">
                    ...
                    <tr>
                        ...
                        <td colspan="14" class="text-center" ng-if="errorMessage" id="errorMessage">
                        <span style="color:red; text-align:center; font-size:15px">
                            <p>@{{ errorMessage}}</p>
                        </span>
                        </td>
