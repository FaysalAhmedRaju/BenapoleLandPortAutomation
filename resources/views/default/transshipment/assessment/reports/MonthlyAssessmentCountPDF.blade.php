...
<html>
<head>
    <title>Yearly Assessment Entry</title>
    <style>
        html {
            margin: 5px 5px 0;
        }
...
<table width="100%;" border="0">
    <tr>
        ...
        <td style="width: 50%; text-align: center">
            ...
            {{$month}}'s Assessment Entry Report
        </td>
...
<table  class="dataTable" style="width: 100%;">
    ...
    <tr>
        ...
        <th style="width:25%; ">Total Assessment</th>
    ...
    @foreach($data as $key => $value)
        <tr>
            ...
            <td>{{ $value->assessment_count }}@php($total_entry+=$value->assessment_count)</td>
