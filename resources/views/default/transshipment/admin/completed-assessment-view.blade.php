...
@section('title', 'Completed Assessment List')
...
@section('script')
    ...
    {!!Html :: script('js/customizedAngular/transshipment/assessment/admin/completed-assessment.js')!!}
@endsection
    ...
    <div class="col-md-12 ng-cloak text-center" ng-app="completedAssessmentApp"
        ...
        <div>
            <div class="form-inline">
                ...
                <button class="btn btn-success" type="button" ng-click="getTodaysCompletedAssessment(date)">Created</button>
                <button class="btn btn-success" type="button" ng-click="getTodaysCompletedAssessment(date,1)">Approved</button>
            ...
            <table   class="table table-bordered paddingStyleTable" >
                ...
                <tr dir-paginate="todaysCompletedAssessment in allTodaysCompletedAssessment | filter:searchTextCompletedAssessment | itemsPerPage:itemPerPage"
                    ...
                    <td style=" padding: 0px;" >
                        @{{ todaysCompletedAssessment.manifest }}
                    </td>
                    ...
                    <td  style=" padding: 0px;" >
                            <a class="btn btn-info"
                               href="/transshipment/assessment-admin/assessement-details-preview/@{{ todaysCompletedAssessment.manifest }}/@{{todaysCompletedAssessment.id}}/@{{todaysCompletedAssessment.partial_status}}"
