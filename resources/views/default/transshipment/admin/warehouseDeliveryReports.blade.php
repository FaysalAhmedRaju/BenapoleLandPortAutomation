...
@section('content')
    <div class="col-md-12 text-center">
        <h3 class="ok" style="font-weight: bold;">WareHouse(Delivery) Reports</h3>
        <hr>


        <div class="col-md-3 reportFormStyle">
            <h4 class="ok headingTxt">Delivery:</h4>

            <form action="{{ url('dateWiseWarehouseDeliveryReportPdf') }}" target="_blank" method="POST"
                  class="form-inline">
                {{ csrf_field() }}
