           ...
           <form  name="truckform">
               <table>
                    <tr>
                        <th>Manifest No : </th>
                        <td>
                            <input type="text" ng-pattern='/^([0-9]{1,10}|[0-9P]{2,6})[\/]{1}([0-9]{1,3}|[(A|a)]{1})[\/]{1}[0-9]{4}$/' required="required"  ng-model="ManifestNo" ng-change="checkManifest(ManifestNo)" name="ManifestNo" id="Manifest_no" class="form-control input-sm" placeholder="Manifest No.">
