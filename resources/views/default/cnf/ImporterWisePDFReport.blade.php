...
<html>
<head>
	<title>Importer Wise Manifest Report</title>
	<style>
    table {
	...
	<body>
		...
		<p class="center">
    		...
    		<span style="font-size: 19px;">Importer Wise Manifest Report</span> <br>
    		Importer No: {{$importerNo}}
    	</p>
    	<h5 style="text-align: right;padding-right: 35px;"> Date: {{$todayWithTime}}</h5>
    	@php($i=0)
		@foreach($importerWiseManifestReport as $key => $manifestDetail)
