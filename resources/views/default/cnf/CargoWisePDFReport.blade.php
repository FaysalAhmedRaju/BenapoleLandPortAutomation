...
<html>
<head>
	<title>Cargo Wise Manifest Report</title>
	<style>
    table {
	...
	<body>
		...
		<p class="center">
    		...
    		<span style="font-size: 19px;">Cargo Wise Manifest Report</span> <br>
    		Cargo Description: {{$cargo_description[0]->goodsName}}
    	</p>
    	<h5 style="text-align: right;padding-right: 35px;"> Date: {{$todayWithTime}}</h5>
    	@php($i=0)
		@foreach($cargoWiseManifestReport as $key => $manifestDetail)
