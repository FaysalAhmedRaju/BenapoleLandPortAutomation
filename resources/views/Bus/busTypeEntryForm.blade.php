...
@section('script')
    ...
    {!! Html::script('js/customizedAngular/busTypeEntry.js') !!}
@endsection
@section('content')
    <div class="col-md-12 ng-cloak" ng-app="BusTypeApp" ng-controller="BusTypeCtrl">
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="radio-inline">
                                    <input type="radio" ng-model="vehicle_type"  name="vehicle_type" id="vehicle_type"
                                     value="1">Truck
                                ...
                                <label class="radio-inline">
                                    <input type="radio" ng-init="vehicle_type=0"  ng-checked="true"  ng-model="vehicle_type" name="vehicle_type" id="vehicle_type" value="0">Bus
