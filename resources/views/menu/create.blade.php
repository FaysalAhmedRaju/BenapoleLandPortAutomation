        ...
        <div class="col-md-8 col-md-offset-2"
            ...
            <form method="POST" class="form-horizontal" action="{{route('menu-save')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{old('module_name')}}" id="module_name"
                           name="module_name"
                ...
                <div class="form-group">
                    ...
                    <label for="module_name">Position:</label>
                    <input type="number" class="form-control" value="{{old('position')}}" id="position" name="position"
