...
class Agent extends User
{
    ...
    {
        if (auth()->check() && Auth::user()->ticket_agent) {
    ...
    {
        return $this->belongsToMany('Models\Category', 'ticketit_categories_users', 'user_id', 'category_id');
    }
    ...
    {
        if ($complete) {
            return $this->hasMany('Models\Ticket', 'agent_id')->whereNotNull('completed_at');
        } else {
            return $this->hasMany('Models\Ticket', 'agent_id')->whereNull('completed_at');
        }
    }
    ...
    {
        if ($complete) {
            return $this->hasMany('Models\Ticket', 'user_id')->whereNotNull('completed_at');
        } else {
            return $this->hasMany('Models\Ticket', 'user_id')->whereNull('completed_at');
        }
    }
    ...
    {
        return $this->hasMany('Models\Ticket', 'agent_id');
    }
    ...
    {
        return $this->hasMany('Models\Ticket', 'user_id');
    }
